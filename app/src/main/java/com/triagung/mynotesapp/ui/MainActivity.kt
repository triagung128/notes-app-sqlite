package com.triagung.mynotesapp.ui
...
import com.triagung.mynotesapp.adapter.NoteAdapter
import com.triagung.mynotesapp.databinding.ActivityMainBinding
import com.triagung.mynotesapp.db.NoteHelper
import com.triagung.mynotesapp.helper.MappingHelper
...
class MainActivity : AppCompatActivity() {
    ...
    private fun loadNoteAsync() {
        lifecycleScope.launch {
            ...
            val noteHelper = NoteHelper.getInstance(this@MainActivity)
            noteHelper.open()
